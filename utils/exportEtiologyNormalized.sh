...
Rscript exportEtiologyCsvNormalized.R 'Etiology/Etiology_cosmic_v3.4.json' Cosmic Etiology/Etiology_cosmic_v3.4.csv
...
Rscript exportEtiologyCsvNormalized.R 'Etiology/Etiology_SATS_TS.json' STS Etiology/Etiology_SATS_TS.csv
