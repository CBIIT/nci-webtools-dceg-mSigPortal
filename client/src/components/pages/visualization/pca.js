          ...
          {pca2 && (
            <div id="pca2Plot">
              ...
              <SvgContainer
                ...
                plotPath={'results/' + pca2}
                txtPath={`results/${pca2Data}`}
              />
              <p className="p-3">
          ...
          {pca3 && (
            <div id="pca3Plot">
              ...
              <SvgContainer
                ...
                plotPath={'results/' + pca3}
                txtPath={`results/${pca3Data}`}
              />
              <p className="p-3">
          ...
          {heatmap && (
            <div id="heatmapPlot">
              ...
              <SvgContainer
                ...
                plotPath={'results/' + heatmap}
                txtPath={`results/${heatmapData}`}
              />
              <p className="p-3">
          ...
          {pubPca2 && (
            <div id="pubPca2Plot">
              ...
              <SvgContainer
                ...
                plotPath={'results/' + pubPca2}
                txtPath={`results/${pubPca2Data}`}
              />
              <p className="p-3">
                The individual PCA plot based on the top two principal
                components helps to explain a majority of the variation in
          ...
          {pubPca3 && (
            <div id="pubPca3Plot">
              ...
              <SvgContainer
                ...
                plotPath={'results/' + pubPca3}
                txtPath={`results/${pubPca3Data}`}
              />
              <p className="p-3">
                The variable PCA plot based on the top two principal components
                helps to explain a majority of the variation in the data. The
